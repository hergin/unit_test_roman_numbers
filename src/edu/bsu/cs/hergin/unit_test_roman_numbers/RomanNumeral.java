package edu.bsu.cs.hergin.unit_test_roman_numbers;
...
public class RomanNumeral {
	 ...
	 * parameter.
	 * 
	 * @param arabic the number in arabic format
	 * @throws NumberFormatException if arabic is not in the range 1 to 3999
	 *                               incluside
	 */
	 ...
	 * example, RomanNumeral("xvii") is 17. Both upper and lower case letters are
	 * allowed.
	 * 
	...
	/**
	 * Find the integer value of letter considered as a Roman numeral. The letter
	 * must be uppercase.
	 * 
	 * @param letter
	...
	/**
	 * Just returns null, I don't know why.
	 * 
	 * @return null
	 */
	public Object returnNullForNoReasonAtAll() {
		return null;
	}
}
